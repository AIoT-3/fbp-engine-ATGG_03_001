...
class WriteSingleResponsePduTest {
    ...
    @Test
    @DisplayName("Modbus PDU 바이트 배열을 읽으면, WriteSingleResponsePdu 객체로 매핑할 수 있다.")
    void read_WhenPduByteArray_ReturnPduEntity() throws IOException {
        ...
        // when
        WriteSingleResponsePdu pdu = WriteSingleResponsePdu.read(in);
